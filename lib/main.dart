...
class _MainPageState extends State<MainPage> with RouteAware {
  ...
  void _initPreferences() async {
    ...
    if (!(preferences.getKeys().contains("currencyParam")) && !(preferences.getKeys().contains("toParam"))) {
      await preferences.setString("currencyParam", "CLP");
      await preferences.setString("toParam", "USD");
    ...
    return new DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          bottom: TabBar(
            tabs: [
              Tab(child: Text("Convertir", style: new TextStyle(
                    fontSize: 18.0,
                  ),
                ),
              ),
              Tab(child: Text("Valores", style: new TextStyle(
                    fontSize: 15.0,
                  ),
                ),
              ),
                          ...
                          child: new Container(
                            child: new TextField(
                              decoration: new InputDecoration(
                                ...
                                hintText: "Buscar (ejm. CLP, EUR, GBP)",
